...
object Models {
  ...
  case class UserGroupFormData(group: UserGroup, users: List[UserFormData], alreadyExists: Boolean, doNotInsert: Boolean, alreadyExistingGroup: Option[UserGroup] = None)
