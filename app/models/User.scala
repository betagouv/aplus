...
object User {
  ...
  val admins =  List(
    ...
    User(UUIDHelper.namedFrom("yan"), Hash.sha256(s"yan"), "Yan TANGUY", "Aide A+", "yan.tanguy@dila.gouv.fr", false, false, false, List(), date, false),
    ...
    User(UUIDHelper.namedFrom("simon"), Hash.sha256(s"simon"), "Simon PINEAU", "Aide A+", "simon.pineau@beta.gouv.fr", true, true, true, List(), date, true),
