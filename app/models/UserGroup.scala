...
case class UserGroup(
  ...
  lazy val organisationSetOrDeducted: Option[String] =
    organisation.orElse(UserGroup.organisationDeductedFromName(name))
}
...
object UserGroup {
  ...
  def organisationDeductedFromName(name: String): Option[String] = {
    ...
    Organisation.all
      .find { organisation =>
        lowerCaseName.contains(organisation.shortName.toLowerCase()) || lowerCaseName.contains(
